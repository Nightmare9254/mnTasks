    ...
    <>
      <main className="main__heading">
        ...
        <div className="heading__buttons">
          <Link to="/sign-up" className="heading__btn">
            Start Now
          </Link>
          <Link to="/login" className="heading__btn-sign">
            Sign In
          </Link>
        </div>
        ...
        <div className="heading__socials">
          <div className="social">
            <a
              href="https://github.com/Nightmare9254"
              rel="noreferrer"
              target="_blank"
            >
              <i>
                <svg width="24" height="24" viewBox="0 0 24 24" name="github">
          ...
          <div className="social">
            ...
            >
              <i>
                <svg width="24" height="24" viewBox="0 0 24 24" name="facebook">
          ...
          <div className="social">
            <a href="https://twitter.com/home" rel="noreferrer" target="_blank">
              <i>
                <svg width="24" height="24" viewBox="0 0 24 24" name="twitter">
